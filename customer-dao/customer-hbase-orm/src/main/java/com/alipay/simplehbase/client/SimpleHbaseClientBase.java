...
abstract public class SimpleHbaseClientBase implements SimpleHbaseClient {
	 ...
	 * @since 1.2.4
	 * @deprecated use
	 *             {@link com.alipay.simplehbase.client.SimpleHbaseClientBase}
	 *             instead protected Table table() method.
	 * */
	@Deprecated
	...
	protected Table table() {
		return hbaseDataSource.getTable(hbaseTableConfig.getHbaseTableSchema()
				.getTableName());
	}
	...
	public Table getTable(String tableName) {
		return hbaseDataSource.getTable(tableName);
	}
