...
public class UserServiceImpl implements UserService {
	...
	public List<User> searchUser(String mobile) {
		List<com.qingting.customer.common.pojo.hbasedo.User> list = userDAO.searchUserByMobile(mobile);
		List<User> result=new ArrayList<User>();
		for (com.qingting.customer.common.pojo.hbasedo.User user : list) {
			User u=new User();
			u.setId(user.getId());
