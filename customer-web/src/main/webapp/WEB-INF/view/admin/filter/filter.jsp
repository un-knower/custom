	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
    			url : "${_path}/admin/filter/listFilter",
    			formId : "_form",
				ajaxData : {//加载表格的请求设置
    				type : "post",
    				dataFormat : "json",
				...
				tools : [
					{text : '新增', clazz : 'btn-info', icon : 'fa fa-plus-circle blue', permission : '/admin/user/edit', handler : function(){
						$table.dialog(null,null,"用户添加",{
							url:'${_path}/admin/filter/insertFilter',
							type:'post',
							callback:function(d){
								$.gritter.add({
									text: d.message,
				...
				columns : [
			        ...
			        {field:'supply', title:'供应商', mobileHide : true},
			        {field:'name', title:'滤芯名字', mobileHide : true},
			        {field:'lifeTime', title:'滤芯寿命', mobileHide : true},
