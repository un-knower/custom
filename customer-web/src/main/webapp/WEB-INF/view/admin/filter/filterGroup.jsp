	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
    			url : "${_path}/admin/filter/listFilterGroup",
    			formId : "_form",
				ajaxData : {//加载表格的请求设置
    				type : "post",
    				dataFormat : "json",
				...
				tools : [
					{text : '新增', clazz : 'btn-info', icon : 'fa fa-plus-circle blue', permission : '/admin/user/edit', handler : function(){
						$table.dialog(null,null,"用户添加",{
							url:'${_path}/admin/filter/insertFilterGroup',
							type:'post',
							callback:function(d){
								$.gritter.add({
									text: d.message,
				...
				columns : [
			        //{field:'id', hide : true},
			        {field:'id'},
			        {field:'oneFilterId', title:'第一级滤芯ID', mobileHide : true },
			        {field:'twoFilterId', title:'第二级滤芯ID', mobileHide : true},
			        {field:'threeFilterId', title:'第三级滤芯ID', mobileHide : true},
			        {field:'fourFilterId', title:'第四级滤芯ID', mobileHide : true},
			        {field:'fiveFilterId', title:'第五级滤芯ID', mobileHide : true},
			        {field:'microId', title:'微生物ID', mobileHide : true},
