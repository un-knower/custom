	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
    			url : "${_path}/admin/formula/listFormula",
    			formId : "_form",
				ajaxData : {//加载表格的请求设置
    				type : "post",
    				dataFormat : "json",
				...
				tools : [
					{text : '新增', clazz : 'btn-info', icon : 'fa fa-plus-circle blue', permission : '/admin/user/edit', handler : function(){
						$table.dialog(null,null,"用户添加",{
							url:'${_path}/admin/formula/insertFormula',
							type:'post',
							callback:function(d){
								$.gritter.add({
									text: d.message,
				...
				columns : [
			        ...
			        {field:'order', title:'第几级滤芯', mobileHide : true},
			        {field:'formula', title:'公式', mobileHide : true},
			        {field:'filterId', title:'滤芯ID', mobileHide : true},
