	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
    			url : "${_path}/admin/water/listWaterQuality",
    			formId : "_form",
				ajaxData : {//加载表格的请求设置
    				type : "post",
    				dataFormat : "json",
				...
				tools : [
					{text : '新增', clazz : 'btn-info', icon : 'fa fa-plus-circle blue', permission : '/admin/user/edit', handler : function(){
						$table.dialog(null,null,"用户添加",{
							url:'${_path}/admin/water/insertWaterQuality',
							type:'post',
							callback:function(d){
								$.gritter.add({
									text: d.message,
				...
				columns : [
			        ...
			        {field:'turbidity', title:'浊度', mobileHide : true},
			        {field:'chlorine', title:'余氯', mobileHide : true},
			        {field:'waterAreaId', title:'自来水公司ID', mobileHide : true},
